  ...
  return (
    <div className="h-screen w-screen flex flex-col p-6 gap-4 inset-0 relative">
      ...
      <button
        ...
        className="absolute top-4 right-4 px-4 py-2 text-sm font-medium text-text/70 bg-surface hover:bg-background-ui/20 hover:text-text hover:shadow-md border border-border rounded-lg transition-all duration-200 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
      >
        {t("onboarding.skip")}
      </button>
